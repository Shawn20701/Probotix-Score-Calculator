...
const Parked_Value = Number(form.elements['Parked'].value);
var Park_Points = Parked_Value * 5;
...
var Total = Door_Points + Obstacle_Points - Obstacle_Penalties_points + Block_Points + Block_Bonus_Points + Pixel_Points + Hill_Points - Major_Points - Minor_Points + Park_Points;
console.log(Total);
